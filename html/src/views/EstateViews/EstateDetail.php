...
<html class="no-js"> <!--<![endif]-->
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-default d-inline-flex justify-content-between align-items-center w-100">
            <div class="container pt-0">
                <!-- Brand and toggle get grouped for better mobile display d-inline-flex justify-content-between -->
                <div class="">
                ...
                <div class="collapse navbar-collapse yamm" id="navigation">
                    ...
                    <ul class="main-nav nav navbar-nav navbar-right">
                        <li class="wow fadeInDown" data-wow-delay="0.2s"><a class="" href="properties.html">Accueil</a></li>
                        <li class="wow fadeInDown" data-wow-delay="0.3s"><a class="" href="property.html">Biens</a></li>
                    </ul>
                </div><!-- /.navbar-collapse -->
            </div><!-- /.container-fluid -->
        </nav>
                                ...
                                <div class="row">
                                    <div class="col-xs-12 m-padding">
                                        <div class="welcome-estate">
                                            <div>
                                                <img src="assets/img/logo.png" alt="logo de lagence Simpl'immo" width="200px">
                                            </div>
                                            <h3>Agence Simpl'immo</h3>
                                            <p class="mt-4 pb-1"><i class="fa fa-map-marker"> </i> 128 Avenue Saint Ouen</p>
                                            <p>75018 Paris</p>
                                            <p class="pb-1"><i class="fa fa-clock-o strong"></i> Du lundi au vendredi:</p>
                                            <p>9h00-12h00 / 14h00-18h30</p>
                                            <p class="pb-1">Le samedi:</p>
                                            <p>9h00-12h00</p>
                                            <p class="pb-1"><i class="fa fa-phone"> </i> +332 34 67 78 90</p>
                                            <p><i class="fa fa-envelope"> </i> contact@simplimmo.com</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
